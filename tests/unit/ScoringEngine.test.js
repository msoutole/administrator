...
const ScoringEngine_1 = require("../../src/analyzers/ScoringEngine");
describe('ScoringEngine', () => {
    ...
    describe('calculateScore', () => {
        it('should calculate overall score with default weights', () => {
            const engine = new ScoringEngine_1.ScoringEngine();
        ...
        it('should use custom weights when provided', () => {
            ...
            const engine = new ScoringEngine_1.ScoringEngine(customWeights);
            const result = engine.calculateScore(mockMetrics);
            expect(result.overall).toBeGreaterThanOrEqual(0);
            expect(result.overall).toBeLessThanOrEqual(100);
        });
...
//# sourceMappingURL=ScoringEngine.test.js.map